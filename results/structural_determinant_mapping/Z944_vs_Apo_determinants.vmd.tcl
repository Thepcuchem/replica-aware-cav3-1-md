mol new Z944_vs_Apo_determinants.pdb type pdb waitfor all
...
mol color Beta
mol selection {protein and resid 351 353 354 355 356 357 384 387 388 872 875 876 916 917 918 919 920 921 925 926 948 950 955 960 1465 1466 1781}
mol material Opaque
mol addrep $molid
...
set sel1_1 [atomselect $molid {protein and name CA and resid 384}]
set sel2_1 [atomselect $molid {protein and name CA and resid 920}]
...
$sel1_1 delete
$sel2_1 delete
set sel1_2 [atomselect $molid {protein and name CA and resid 356}]
set sel2_2 [atomselect $molid {protein and name CA and resid 1781}]
...
set sel2_3 [atomselect $molid {protein and name CA and resid 917}]
...
set sel2_4 [atomselect $molid {protein and name CA and resid 876}]
...
set sel2_5 [atomselect $molid {protein and name CA and resid 916}]
...
$sel1_5 delete
$sel2_5 delete
set sel1_6 [atomselect $molid {protein and name CA and resid 384}]
set sel2_6 [atomselect $molid {protein and name CA and resid 872}]
...
$sel1_6 delete
$sel2_6 delete
set sel1_7 [atomselect $molid {protein and name CA and resid 384}]
set sel2_7 [atomselect $molid {protein and name CA and resid 875}]
...
set sel2_8 [atomselect $molid {protein and name CA and resid 921}]
...
$sel1_8 delete
$sel2_8 delete
set sel1_9 [atomselect $molid {protein and name CA and resid 354}]
set sel2_9 [atomselect $molid {protein and name CA and resid 926}]
...
$sel1_9 delete
$sel2_9 delete
set sel1_10 [atomselect $molid {protein and name CA and resid 351}]
set sel2_10 [atomselect $molid {protein and name CA and resid 356}]
