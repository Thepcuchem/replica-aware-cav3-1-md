mol new mZ944_vs_Apo_determinants.pdb type pdb waitfor all
...
mol color Beta
mol selection {protein and resid 353 354 355 356 357 384 916 917 918 919 920 921 923 924 925 1460 1461 1462 1463 1465 1466 1780 1781 1782 1816}
mol material Opaque
mol addrep $molid
...
set sel1_1 [atomselect $molid {protein and name CA and resid 357}]
set sel2_1 [atomselect $molid {protein and name CA and resid 1781}]
...
$sel1_1 delete
$sel2_1 delete
set sel1_2 [atomselect $molid {protein and name CA and resid 1781}]
set sel2_2 [atomselect $molid {protein and name CA and resid 1816}]
...
$sel1_2 delete
$sel2_2 delete
set sel1_3 [atomselect $molid {protein and name CA and resid 384}]
set sel2_3 [atomselect $molid {protein and name CA and resid 921}]
...
$sel1_3 delete
$sel2_3 delete
set sel1_4 [atomselect $molid {protein and name CA and resid 384}]
set sel2_4 [atomselect $molid {protein and name CA and resid 917}]
...
$sel1_4 delete
$sel2_4 delete
set sel1_5 [atomselect $molid {protein and name CA and resid 384}]
set sel2_5 [atomselect $molid {protein and name CA and resid 1465}]
...
$sel1_5 delete
$sel2_5 delete
set sel1_6 [atomselect $molid {protein and name CA and resid 354}]
set sel2_6 [atomselect $molid {protein and name CA and resid 1461}]
...
$sel1_6 delete
$sel2_6 delete
set sel1_7 [atomselect $molid {protein and name CA and resid 355}]
set sel2_7 [atomselect $molid {protein and name CA and resid 924}]
...
$sel1_7 delete
$sel2_7 delete
set sel1_8 [atomselect $molid {protein and name CA and resid 384}]
set sel2_8 [atomselect $molid {protein and name CA and resid 918}]
...
$sel1_8 delete
$sel2_8 delete
set sel1_9 [atomselect $molid {protein and name CA and resid 357}]
set sel2_9 [atomselect $molid {protein and name CA and resid 1462}]
...
$sel1_9 delete
$sel2_9 delete
set sel1_10 [atomselect $molid {protein and name CA and resid 357}]
set sel2_10 [atomselect $molid {protein and name CA and resid 1461}]
